...
import bucket.sdk.deprecated.cache.Preferences
import bucket.sdk.deprecated.callbacks.*
import bucket.sdk.deprecated.models.*
import bucket.sdk.deprecated.extensions.bucketError
...
//                    }
        ...
        @JvmStatic fun reporting(startTime: String, endTime: String, employeeId: String = "", terminalId: String, callback: Reporting?) {
            ...
            val url = environment.report.build().toString()
                                    ...
                                    with(transactionObject) {
                                        transactionsList.add(
                                                ReportTransaction(
                                                        ...
                                                        refunded = optString("refunded"),
                                                        refundedBy = optString("refundedBy"),
                                                        redeemed = optString("redeemed"),
                                                        redeemedBy = optString("redeemedBy"),
                                                        locationId = optString("locationId"),
                                                        clientTransactionId = optString("clientTransactionId"),
                                                        terminalCode = optString("terminalCode"),
                                                        employeeId = optInt("employeeId")))
                                    }
                                }

//                                bucketTransactionId: Int?,
//                                val created: String?,
//                                val amount: Double?,
...
//                                val employeeId: Int?)
        ...
        @JvmStatic fun refund(customerCode: String, terminalId: String?, callback: RefundTransaction?) {
            ...
            val url = environment.transaction.appendPath(customerCode).build().toString()
